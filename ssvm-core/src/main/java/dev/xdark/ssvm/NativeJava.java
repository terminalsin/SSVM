...
import dev.xdark.ssvm.execution.rewrite.array.BooleanArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.array.ByteArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.array.CharArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.array.DoubleArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.method.DynamicCallProcessor;
import dev.xdark.ssvm.execution.rewrite.array.FloatArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldByteProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldCharProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldDoubleProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldFloatProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldIntProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldLongProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldReferenceProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetFieldShortProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticByteProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticCharProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticDoubleProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticFloatProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticIntProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticLongProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticReferenceProcessor;
import dev.xdark.ssvm.execution.rewrite.field.GetStaticShortProcessor;
import dev.xdark.ssvm.execution.rewrite.array.IntArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.array.LongArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldByteProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldCharProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldDoubleProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldFloatProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldIntProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldLongProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldReferenceProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutFieldShortProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticByteProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticCharProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticDoubleProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticFloatProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticIntProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticLongProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticReferenceProcessor;
import dev.xdark.ssvm.execution.rewrite.field.PutStaticShortProcessor;
import dev.xdark.ssvm.execution.rewrite.array.ReferenceArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.array.ShortArrayProcessor;
import dev.xdark.ssvm.execution.rewrite.VMCastProcessor;
import dev.xdark.ssvm.execution.rewrite.method.VMInterfaceCallProcessor;
...
public final class NativeJava {
	...
	static void setInstructions(VirtualMachine vm) {
		...
		vmi.setProcessor(VM_CONSTANT_INT, new dev.xdark.ssvm.execution.rewrite.constant.ConstantIntProcessor());
		vmi.setProcessor(VM_CONSTANT_FLOAT, new dev.xdark.ssvm.execution.rewrite.constant.ConstantFloatProcessor());
		vmi.setProcessor(VM_CONSTANT_LONG, new dev.xdark.ssvm.execution.rewrite.constant.ConstantLongProcessor());
		vmi.setProcessor(VM_CONSTANT_DOUBLE, new dev.xdark.ssvm.execution.rewrite.constant.ConstantDoubleProcessor());
		vmi.setProcessor(VM_CONSTANT_REFERENCE, new dev.xdark.ssvm.execution.rewrite.constant.ConstantReferenceProcessor());
